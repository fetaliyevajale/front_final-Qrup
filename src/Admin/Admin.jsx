...
import VisionMissionForm from "./VisionMission/VisionMissionForm";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/vision-mission-form" element={<VisionMissionForm />} />
        <Route path="/easy_step_to_buy_property" element={<VisionMissionForm />} />
